                ...
                <?php if(!empty($officials)): ?>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <a  type="button" href="#edit" data-toggle="modal" onclick="editOfficial(this)" title="Edit Official" data-id="<?= $row['id'] ?>" data-name="<?= $row['name'] ?>" 
                                data-chair="<?= $row['chair_id'] ?>" data-pos="<?= $row['pos_id'] ?>" data-start="<?= $row['termstart'] ?>" 
                                data-end="<?= $row['termend'] ?>" data-status="<?= $row['status'] ?>" data-avatar="<?= $row['avatar'] ?>"> 
