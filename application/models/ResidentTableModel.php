...
class ResidentTableModel extends CI_Model {
    ...
    var $column_search = array('firstname','middlename','lastname','national_id', 'alias','birthdate','civilstatus','gender','voterstatus','resident_type', 'pwd'); //set column field database for datatable searchable 
